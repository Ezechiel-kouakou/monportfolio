...
const handleSubmit = async () => {
  ...
  try {
    ...
    const apiUrl = isLocal ? "http://localhost/mon-portfolio/traitment.php" : "/traitment.php";
    ...
    if (result.success) {
      ...
      setTimeout(() => {
        Object.assign(form, { role: "particulier", entreprise: "", lastname: "", firstname: "", email: "", message: "" });
      }, 500);
    } else {
