  ...
  >
    <div
      :class="[
        ...
        isScrolled
          ? 'bg-white dark:bg-noir-piano w-full justify-around py-4 md:py-6 border-t border-zinc-200 dark:border-white rounded-t-[2.5rem] shadow-lg dark:shadow-dock-brillant pb-[calc(1rem+env(safe-area-inset-bottom))]'
          : 'max-w-7xl justify-center p-3 md:p-4 bg-white/90 dark:bg-noir-piano/40 border-x-2 border-b-2 border-t-0 border-zinc-200 dark:border-white rounded-b-2xl backdrop-blur-md',
      ]"
    >
      <div
        :class="[
      ...
      >
        <a
          ...
          :class="[
            ...
            isScrolled
              ? 'nav-icon-dock'
              : 'nav-link-top font-bold uppercase tracking-[0.1em] md:tracking-[0.2em] text-[10px] md:text-xs',
...
import { Home, Briefcase, FolderCode, Mail } from "lucide-vue-next";
