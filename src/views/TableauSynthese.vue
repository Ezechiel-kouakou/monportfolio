  ...
  <div class="min-h-screen bg-[#f3f2ef] font-sans text-[#000000e6] font-family: Verdana, Geneva, Tahoma, sans-serif; p-4 md:p-8">
    ...
    <div class="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div v-if="loading" class="bg-white rounded-xs border border-gray-200 shadow-sm overflow-hidden animate-pulse">
          ...
          <div class="p-6 space-y-4">
            ...
            <div class="flex gap-4">
              ...
              <div v-for="i in 6" :key="i" class="h-4 flex-1 bg-gray-200 rounded"></div>
            </div>
            <!-- Rows skeleton -->
            <div v-for="i in 5" :key="i" class="flex gap-4 items-center py-3 border-t border-gray-100">
              <div class="h-4 w-1/4 bg-gray-100 rounded"></div>
              <div class="h-4 w-16 bg-gray-100 rounded"></div>
              <div v-for="j in 6" :key="j" class="flex-1 flex justify-center">
            ...
            <table class="w-full text-[13px] border-collapse">
              ...
              <tbody class="divide-y divide-gray-100">
                <tr v-if="realisations.length === 0">
                  <td :colspan="2 + skillLabelsFull.length" class="px-6 py-20 text-center">
                    <div class="flex flex-col items-center gap-3 opacity-40">
                      ...
                      <p class="text-xs font-light lowercase tracking-widest italic">aucune compétence n'a été rajoutée pour le moment.</p>
                    </div>
                  </td>
                </tr>
                <tr v-else v-for="real in realisations" :key="real.id" class="hover:bg-blue-50/20 transition-colors">
                  ...
                  <td class="px-4 py-6 text-center text-gray-500 font-medium border-r border-gray-50 italic whitespace-nowrap">{{ real.periode }}</td>
      ...
      <div class="lg:col-span-3 space-y-6">
        ...
        <!-- SKELETON : Documents -->
        <div v-if="loading" class="bg-white rounded border border-gray-200 shadow-sm animate-pulse">
          <div class="p-4 border-b border-gray-100">
            <div class="h-5 w-40 bg-gray-200 rounded"></div>
          </div>
          <div class="p-3 space-y-3">
            <div v-for="i in 5" :key="i" class="p-3 flex items-center gap-3">
        ...
        <!-- Documents réels -->
        <div v-else class="bg-white rounded border border-gray-200 shadow-sm sticky top-8">
          <div class="p-4 border-b border-gray-100">
